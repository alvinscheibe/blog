          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[60px]">
            <div className="lg:col-span-5 md:col-span-6">
              <div className="team p-12 rounded-md shadow-md dark:shadow-gray-800 dark:border-gray-700 bg-white dark:bg-slate-900 relative">
                ...
                <img src="alvin-scheibe.jpg" className="h-32 w-32 rounded-full shadow-md dark:shadow-gray-800" alt="" />
              ...
              <div className="lg:ml-5">
                ...
                <div className="mt-6">
                  <a href="contact-one.html"
                     className="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mr-2 mt-2"><i
                    className="uil uil-envelope"></i>Contact me</a>
                </div>
              </div>
            </div>
          </div>
